...
For Wan2.1-T2V-1.3B model

v3-1.3B Changes:
- Optimized for Wan2.1-T2V-1.3B model (smaller, faster)
...
# =============================================================================
# Model Constants for Wan2.1-1.3B
# =============================================================================
MODEL_TARGET_FPS = 16
MODEL_FRAME_LIMIT = 81
MODEL_FRAME_LIMIT_LOW_VRAM = 33  # Low VRAM mode
...
def main():
    parser = argparse.ArgumentParser(description="Compare forward and backward video denoising loss for Wan2.1-1.3B")
    ...
    parser.add_argument("--model_id_with_origin_paths", type=str,
                        ...
                        help="Model paths for Wan2.1-1.3B")
    ...
    parser.add_argument("--output_path", type=str, default="./result_output_1.3b.json", help="Output path")
    ...
    # Select timesteps to test (uniformly sample num_timesteps from all timestep indices)
    # e.g., num_timesteps=10, total_timesteps=1000 -> indices 91, 182, 273, ..., 909
